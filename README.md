...
## Access API HuggingFace (if you created account else create now!), create a new token:<img src="tokens.png">More details:"https://www.youtube.com/watch?v=n28awivN2FA"
## Create .env file
